...
<head>
    ...
    <title>Manage Users | TechMatts Admin</title>
...
<body>
    <div class="admin-container">
        ...
        <div class="admin-content">
            ...
            <div class="search-filter-container">
                ...
                <a href="admin-add-user.php" class="btn-add">
            ...
            <table class="user-table">
                ...
                <tbody id="users-table-body">
                    ...
                    // Fetch all users
                    $stmt = $pdo->query("
                        SELECT user_id, first_name, last_name, email, phone, role, is_active, registration_date 
                        FROM users 
    ...
    $avatarUrl = "https://ui-avatars.com/api/?name=" . urlencode($fullName) . "&background=e2136e&color=fff";
?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="admin-user-details.php?id=<?= $user['user_id'] ?>" class="action-btn btn-view">
                                    <i class="fas fa-eye"></i> View
                                </a>
                                <a href="admin-edit-user.php?id=<?= $user['user_id'] ?>" class="action-btn btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="#" class="action-btn btn-delete" onclick="confirmDelete('<?= $user['user_id'] ?>')">
    ...
    <script>
        function confirmDelete(userId) {
            if (confirm('Are you sure you want to delete this user? This action cannot be undone!')) {
                fetch('admin_api.php?action=delete_user&id=' + userId)
        ...
        function filterUsers() {
            ...
            rows.forEach(row => {
                ...
                const rowRole = row.cells[4].querySelector('span').textContent.toLowerCase();
                const rowStatus = row.cells[5].querySelector('span').textContent.toLowerCase();
